...
const MAPA_PLACA_ZONA_LUNES = {
    "KOL802": "M9552", "TJX795": "M9553", "WHN436": "M9554", "SMH182": "M9555",
    "SLI587": "M9556", "EYZ091": "M9558",
    ...
    "SQB119": "P7005B", "EQY944": "DOBLE FRECUENCIA"
};

const MAPA_PLACA_ZONA_MARTES = {
    "KOL802": "M9552", "TJX795": "M9553", "WHN436": "M9554", "SMH182": "M9555",
    "SLI587": "M9556", "EYZ091": "M9557",
    "SPU120": "M9601", "SXF257": "M9602", "VZD334": "M9603", "SNP761": "M9604",
    "WFV015": "M9605", "ESU446": "M9606", "EQY944": "P7009",
    "WHM896": "M9453", "LUM993": "M9454", "SPQ814": "M9455", "TZM674": "M9456",
    "WHM317": "M9457", "PEK019": "M9458", "SJT873": "M9459", "WLC133": "M9460",
    "WTN748": "P7004", "EST067": "P7005", "ERK303": "P7006", "TNH494": "P7007",
    "SQB119": "ARMENIA"
...
const MAPA_PLACA_ZONA_SABADO = {
    "WHM896": "M9453", "LUM993": "M9454", "SPQ814": "M9455", "TZM674": "M9456",
    "WHM317": "M9457", "PEK019": "M9458", "SJT873": "M9459", "WLC133": "M9460",
    "WTN748": "P7004", "EST067": "P7005", "ERK303": "P7006", "TNH494": "P7007",
    "EQY944": "FLEISCHMANN",
    "SPU120": "M9601", "SXF257": "M9602", "VZD334": "M9603", "SNP761": "M9604",
    "WFV015": "M9605", "ESU446": "M9606", "SQB119": "FLEISCHMANN",
    "KOL802": "M9552", "TJX795": "M9553", "WHN436": "M9554", "SMH182": "M9555",
    "SLI587": "M9556", "TRL186": "M9557", "EYZ091": "M9558", "TTL256": "M9559"
};
...
const LISTA_AUXILIARES_ALPINA = [
    "NO APLICA",
    "JHON WILSON GIRALDO CARVAJAL", "YHONY ALEXANDER LOPEZ LOPEZ", "ROVINSON TORRES RIVERA",
    "JUAN ESTEBAN GALLEGO DIEZ", "MILTON GILMER OSORIO CALLE", "ARBEY DE JESUS LARGO LARGO",
    "CAMILO SUAREZ GARCIA", "CESAR AUGUSTO CASTILLO LONDOÑO", "JUAN JOSE CONTRERAS HERNANDEZ",
    "CRISTIAN CAMILO OSPINA PARRA", "ANDRES MATEO VILLALBA DIAZ", "VICTOR ALFONSO PULGARIN MEJIA",
    "CHRISTIAN DAVID CAICEDO MONTAÑO", "JOSE ALEXANDER CONSTAIN PERLAZA", "EDWIN MAURICIO GOMEZ GALINDO",
    "ADRIAN FELIPE MARTINEZ ORTEGON", "CARLOS ANDRES PINEDA CANO", "JUAN ALEJANDRO FRANCO MARIN",
    "LUIS CARLOS CADAVID RESTREPO", "BRAHIAN STIVEN VALENCIA IGLESIAS", "JOHN EDWAR ZAPATA ACEVEDO",
    "BRANDON STEVEN GIL BAEZ", "JUAN MANUEL DELGADO NARVAEZ", "YEISON DAVID RENDON SOTO",
    "SEBASTIAN VILLADA VELASQUEZ", "CAMILO ANDRES CONTRERAS RIVAS", "JUAN DAVID QUINTERO GRAJALES",
    "CRISTIAN FABIAN CAMACHO MARTINEZ", "DIORLAN ANTONIO MESA FLOREZ", "ANDRES FELIPE RIOS CAICEDO",
    "SANTIAGO HENAO MORALES", "ANDRES CAMILO MUÑOZ CAICEDO", "CAMILO LEANDRO GUECHE PEÑA",
    "GERMAN GALVEZ CORTES", "JHON FREDY MORENO", "ELKIN GARCIA OCAMPO",
    "SEBASTIAN MONTES RENDON", "JUAN JOSE HIGUITA RESTREPO", "CARLOS ALBERTO JIMENEZ JACOME",
    "ESTEBAN GONZALEZ DIAZ", "OSCAR MAURICIO RESTREPO MORENO", "MICHAEL STEVEN HENAO RODRIGUEZ",
...
function buscarConductorPorPlaca(placaId, conductorId) {
    ...
    placaInput.addEventListener("input", function () {
        ...
        const mapaPlacasHoy =
            (diaActual === 'Lunes') ? MAPA_PLACA_ZONA_LUNES :
                (diaActual === 'Martes') ? MAPA_PLACA_ZONA_MARTES :
                    (diaActual === 'Miercoles') ? MAPA_PLACA_ZONA_MIERCOLES :
                        (diaActual === 'Jueves') ? MAPA_PLACA_ZONA_JUEVES :
                            (diaActual === 'Viernes') ? MAPA_PLACA_ZONA_VIERNES :
                                (diaActual === 'Sabado') ? MAPA_PLACA_ZONA_SABADO : null;
...
// Precios ESPECIFICOS para ZENU (Actualizado 2026)
const PRECIOS_ZENU = {
    "PEREIRA": 224000,
    "DOSQUEBRADAS": 224000,
    "CARTAGO": 290000,
    "SANTA ROSA": 228000,
    "BELEN": 329000,
    "ARGELIA-EL CAIRO": 365000,
    "ARABIA-ALTAGRACIA": 248000,
    "MARSELLA": 280000,
    "BALBOA LA CELIA": 378000,
    "LA VIRGINA -BELALCAZAR": 304000,
    "PEREIRA-DOSQUEBRADAS": 248000,
    "BELEN MISTRATO": 459000,
    "AGUILA-ANSERMA NUEVO": 342000,
    "VITERBO": 348000,
    "APIA- PUEBLO RICO": 345000,
    "SANTUARIO": 306000
};
...
const POBLACIONES_RISARALDA = [
    ...
    "PUEBLO RICO-SANTA CECILIA", "GUATICA-RISARALDA", "PEREIRA-DOSQUEBRADAS", "PEREIRA FLEISCHMANN",
...
function actualizarPoblaciones(prefix = "") {
    ...
    if (isAlpinaLike && zonaContainer) {
        ...
        if (zonaParaAutoFill) {
            ...
            const placaEl = document.getElementById(prefix + "placa");
            const placaVal = placaEl ? placaEl.value.toUpperCase().replace(/[\s-]/g, '') : "";

            for (let dayKey in MAPA_ZONA_POBLACION_ALPINA) {
                if (normalize(dayKey) === diaBusqueda) {
                    // Lógica especial para la zona FLEISCHMANN los sábados (Ambigüedad entre Armenia y Pereira)
                    if (zonaParaAutoFill === 'FLEISCHMANN' && normalize(dayKey) === 'Sabado') {
                        if (placaVal === 'SQB119') { autoPobName = 'ARMENIA'; break; }
                        if (placaVal === 'EQY944') { autoPobName = 'DOSQUEBRADAS'; break; }
                    }
            ...
            if (autoPobName) {
                ...
                const manualMapeo = {
                    ...
                    "CENTRO GALERIA": "MANIZALES",
                    "CENTRO LA CABAÑA": "MANIZALES",
                    "LA FRANCIA": "MANIZALES",
                    "SAN JOAQUIN": "MANIZALES",
                    "EL CARMEN": "MANIZALES",
