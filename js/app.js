...
const LISTA_AUXILIARES_ALPINA = [
    ...
    "BRANDON STEVEN GIL BAEZ", "DIORLAN ANTONIO MESA FLORES", "YEISON DAVID RENDON SOTO",
    "SEBASTIAN VILLADA VELASQUEZ", "JOSE ALEXANDER CONSTAIN PERLAZA", "CAMILO ANDRES CONTRERAS RIVAS",
    "CHRISTIAN DAVID CAICEDO MONTAÑO", "EDWIN MAURICIO GOMEZ GALINDO", "JUAN DAVID QUINTERO GRAJALES",
    "CARLOS ANDRES PINEDA CANO", "JUAN MANUEL DELGADO NARVAEZ", "JHON FREDY MORENO",
    "ESTIVEN GUTIERREZ SALAZAR", "JHON WILSON GIRALDO CARVAJAL", "ANDRES FELIPE VILLA OSORIO",
    "MICHAEL STEVEN HENAO RODRIGUEZ", "ANDRES FELIPE RIOS CAICEDO", "BRAHIAN STIVEN VALENCIA IGLESIAS",
    "ARBEY DE JESUS LARGO LARGO", "ROVINSON TORRES RIVERA", "LUIS CARLOS CADAVID RESTREPO",
    "CRISTIAN FABIAN CAMACHO MARTINEZ", "OSCAR MAURICIO RESTREPO MORENO", "CESAR CASTILLO",
    "JUAN DIEGO FRANCO VERGARA", "CRISTIAN CAMILO OSPINA PARRA"
];
