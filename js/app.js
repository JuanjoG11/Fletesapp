...
function buscarConductorPorPlaca(placaId, conductorId) {
    ...
    placaInput.addEventListener("input", function () {
        ...
        const mapaPlacasHoy = (diaActual === 'Miercoles') ? MAPA_PLACA_ZONA_MIERCOLES : (diaActual === 'Jueves') ? MAPA_PLACA_ZONA_JUEVES : (diaActual === 'Viernes') ? MAPA_PLACA_ZONA_VIERNES : (diaActual === 'Sabado') ? MAPA_PLACA_ZONA_SABADO : null;
...
const MAPA_ZONA_POBLACION_ALPINA = {
    ...
    "Sabado": {
        ...
        "FC03": "MANIZALES - VILLAMARIA",
        "M9555": "MANIZALES - VILLAMARIA",
        "DEL CAMPO": "MANIZALES - VILLAMARIA",
        "M9556": "MANIZALES - VILLAMARIA",
        ...
        if (zonaParaAutoFill) {
            ...
            if (autoPobName) {
                ...
                const manualMapeo = {
                    ...
                    "CENTRO GALERIA": "MANIZALES - VILLAMARIA",
                    "CENTRO LA CABAÑA": "MANIZALES - VILLAMARIA",
                    "LA FRANCIA": "MANIZALES - VILLAMARIA",
                    "SAN JOAQUIN": "MANIZALES - VILLAMARIA",
                    "EL CARMEN": "MANIZALES - VILLAMARIA",
