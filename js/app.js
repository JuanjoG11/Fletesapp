...
const LISTA_AUXILIARES_ALPINA = [
    "NO APLICA",
    "JHON WILSON GIRALDO CARVAJAL", "ROVINSON TORRES RIVERA", "ARBEY DE JESUS LARGO LARGO",
    "CESAR AUGUSTO CASTILLO LONDOÑO", "CRISTIAN CAMILO OSPINA PARRA", "VICTOR ALFONSO PULGARIN MEJIA",
    ...
    "SEBASTIAN VILLADA VELASQUEZ", "CAMILO ANDRES CONTRERAS RIVAS", "ARNULFO STERLING PELAEZ",
    "JUAN DAVID QUINTERO GRAJALES", "CRISTIAN FABIAN CAMACHO MARTINEZ", "DIORLAN ANTONIO MESA FLOREZ",
    "ANDRES FELIPE RIOS CAICEDO", "QUEBIN ANDRES LOTERO ZAPATA", "JORGE ELIECER CRUZ PINEDA",
    "SANTIAGO HENAO MORALES", "JHON HENRY GARCIA PATIÑO", "ANDRES CAMILO MUÑOZ CAICEDO",
    "CAMILO LEANDRO GUECHE PEÑA", "GERMAN GALVEZ CORTES", "OSCAR MAURICIO RESTREPO MORENO",
