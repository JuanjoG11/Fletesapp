-- ==========================================================
-- 💰 MIGRACIÓN: GESTIÓN DE PRECIOS DINÁMICA
-- ==========================================================
...
-- Política: Todos pueden VER los precios (necesario para operarios crear fletes)
create policy "Todos pueden ver precios"
on precios_fletes for select
using (true);

-- Política: Solo ADMIN puede EDITAR/INSERTAR precios
-- (Asumiendo que los admins tienen rol 'admin' en metadata o perfil, 
--  por simplicidad aquí permitimos update a autenticados, la UI filtra,
--  pero idealmente se restringe por rol en una política más avanzada)
...
-- 3. INSERTAR DATOS INICIALES (MIGRACIÓN DESDE APP.JS)

-- LIMPIAR PRIMERO SI YA EXISTÍAN DE PRUEBAS
...
-- PRECIOS_ZENU (Actualizado 2026)
('ZENU', 'PEREIRA', 224000),
('ZENU', 'DOSQUEBRADAS', 224000),
('ZENU', 'CARTAGO', 290000),
('ZENU', 'SANTA ROSA', 228000),
('ZENU', 'BELEN', 329000),
('ZENU', 'ARGELIA-EL CAIRO', 365000),
('ZENU', 'ARABIA-ALTAGRACIA', 248000),
('ZENU', 'MARSELLA', 280000),
('ZENU', 'BALBOA LA CELIA', 378000),
('ZENU', 'LA VIRGINA -BELALCAZAR', 304000),
('ZENU', 'PEREIRA-DOSQUEBRADAS', 248000),
('ZENU', 'BELEN MISTRATO', 459000),
('ZENU', 'AGUILA-ANSERMA NUEVO', 342000),
('ZENU', 'VITERBO', 348000),
('ZENU', 'APIA- PUEBLO RICO', 345000),
('ZENU', 'SANTUARIO', 306000),
...
('TAT_UNILEVER', 'NEGOCIACIÓN MY1-8 MILLONES', 200000),
...
('TAT_FAMILIA', 'NEGOCIACIÓN MYMY 1-4 MILLONES', 80000),
('TAT_FAMILIA', 'NEGOCIACIÓN MY4-8 MILLONES', 120000),
('TAT_FAMILIA', 'NEGOCIACIÓN MY8-12 MILLONES', 160000),
('TAT_FAMILIA', 'NEGOCIACIÓN MYMY +12 MILLONES', 200000);
